...
IMAGES OF SWEEP AND POINTS AND MERGE BLOCKS
...
IMAGE OF CUTOUT ORIGIN CHANGED
...
IMAGES OF THE MIRRORING PLANE AND CODE

With all of this completed, I was able to create a fully functioning model of customizable sunglasses. The video linked at the beginning of the report shows all of the functionality, and the grasshopper file is located [here]() as well. 
